...
class MyAccountManager(BaseUserManager):
    def create_user(self, primeiro_nome, ultimo_nome, username, email, password=None):
        if not email:
            raise ValueError('usuário precisa de um email de acesso')
        if not username:
    ...
    def create_superuser(self, primeiro_nome, ultimo_nome, email, username, password):
